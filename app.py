...
from services.extract_entities import get_threat_data
...
def process_pdf(pdf_path):
    ...
    try:
        ...
        #print(f"Sanitized Text Preview: {sanitized_text[:500]}")  # Check sanitized text
        ...
        print(f"Extracted IoCs: {iocs}")  # Debug IoCs

        threat_data = get_threat_data(sanitized_text)
        ...
        result = {
            ...
            'TTPs': ttp_data['TTPs'],
            'Malware': malware_data['Malware'],
            'Actors': threat_data['Actors'],
            'Entities': threat_data['Entities']
        }
...
if __name__ == "__main__":
    ...
    try:
        ...
        if threat_intelligence_data:
            ...
            print(f"IP addresses: {threat_intelligence_data['IP addresses']}")
            print(f"Domains: {threat_intelligence_data['Domains']}")
            print(f"Email addresses: {threat_intelligence_data['Email addresses']}")
            print(f"File hashes: {threat_intelligence_data['File hashes']}")
