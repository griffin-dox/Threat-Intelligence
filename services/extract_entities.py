...
def extract_targeted_entities(text):
    ...
    country_keywords = {"Colombia", "Ecuador", "Ukraine", "Armenia", "Azerbaijan", "Russia", "Belarus", "Moldova", "Vietnam", "Thailand", "Indonesia", "Malaysia", "Europe", "United States", "China", "Iran", "North Korea"}
    region_keywords = {"Nagorno-Karabakh", "Transnistria", "Luhansk", "Donetsk", "Crimea", "South China Sea", "Balkan Region"}
